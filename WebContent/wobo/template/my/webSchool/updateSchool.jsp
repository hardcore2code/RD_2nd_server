                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form role="form" name="func" id="myForm">
                                    	<input type="hidden" value="${school_id}" id="schoolId" name="schoolId">
                                    	<input type="hidden" value="${school_summary}" id="school_summary" name="school_summary">
                                        <div class="form-group">
                                        <label for="disabledSelect">中小学</label>
                                        <label for="small" class="radio-inline">
                                        	<input type="checkbox" name="schoolCategory" id="schoolCategory1" value="0" ${school_category0 == "0" ? "checked" : ""}/>小学
                                        </label>
                                        <label for="middle" class="radio-inline">
                                        	<input type="checkbox" name="schoolCategory" id="schoolCategory2" value="1" ${school_category1 == "1" ? "checked" : ""}/>初中
                                        </label>
                                        <label for="high" class="radio-inline">
                                        	<input type="checkbox" name="schoolCategory" id="schoolCategory3" value="2" ${school_category2 == "2" ? "checked" : ""}/>高中
                                        </label>
                                         </div>
                                        <div class="form-group">
                                            <label>所属区</label>
                                            ...
                                            <c:forEach var="area" items="${areas}">
                                            	<option value="${area.dict_id}" ${area.dict_id == belong_area  ? "selected" : ""}>${area.dict_value}</option>
                                            </c:forEach>
                                            </select>
                                           <%--  <select name="county" id="county" style="width: 380px; height: 35px">
                                            <c:forEach var="country" items="${countries}">
                                            	<option value="${country.dict_id}" ${country.dict_id == belong_county ? "selected" : ""}>${country.dict_value}</option>
                                            </c:forEach>
                                            </select> --%>
                                        </div>
                                        <div class="form-group">
                                            <label>学校名称</label>
                                            <input class="form-control" id="name" name="name" value="${school_name }" style="width: 400px">
                                        </div>
                                        <div class="form-group">
                                            <label>学校LOGO</label>
                                            <div class="form-group" align="left">
                                            	<img id="uploadLogo" src="<%=path %>${school_logo }" width="35%" >
                                            	<img id="diyLogo" src="<%=path %>${school_logo }" width="40%" hidden="true">
                                        		<br/><br/><span style=color:#8E8E8E>上传图片的格式可为：*.jpg,*.png,*.jpeg</span>
                                        	</div>
                                        	...
                                        	<!-- <button type="button" class="btn btn-success" id="logoUploadId" onclick="ajax_upload_logo();" disabled="disabled">上传图片</button> -->
                                        </div>
                                        <div class="form-group">
                                            <label>主页图片</label>
                                            <div class="form-group" align="left">
                                            	<img id="uploadIndex" src="<%=path %>${school_pic }" width="35%" >
                                       ...
                                       <%--  <div class="form-group">
                                            <label>URL地址</label>
                                            <input class="form-control" id="url" name="url" value="${school_url }">
                                        </div>
                                        <div class="form-group">
                                            <label>模板</label>
                                        ...
                                        <div class="form-group">
                                            <input type="hidden" value="${school_logo}" id="logoPath" name="logoPath">
                                       		<input type="hidden" value="${school_pic}" id="indexPath" name="indexPath">
...
<script type="text/javascript">
	...
	summary.innerHTML=$("#school_summary").val();
</script>
<script type="text/javascript">
