...
<body>
	<form action="demo/shareFile" method="post" enctype="multipart/form-data">
	...
	<script type="text/javascript">
		$(function(){
			$("#file_upload").uploadify({
				...
				'uploader' : 'http://localhost:9001/demo/shareFile', //指定服务器端上传处理文件，默认‘upload.php’

				'auto' : true, //自动上传
				'buttonImage' : 'demo/file/uploadify/uploadify-browse.png', //浏览按钮背景图片
				'multi' : false, //单文件上传
				'fileTypeExts' : '*.doc; *.docx; *.xls; *.xlsx; *.ppt; *.pptx;', //允许上传的文件后缀
