...
/**
 * create by woody 20170609
 * 图片验证码
 */
public class MyCaptchaRender extends Render {

	private static String captchaName = "_woody_captcha";

	// 默认的验证码大小
	private static final int WIDTH = 116, HEIGHT = 39;
	// 验证码随机字符数组
//	private static final String[] strArr = {"3", "4", "5", "6", "7", "8", "9", "A", "B", "C", "D", "E", "F", "G", "H", "J", "K", "M", "N", "P", "Q", "R", "S", "T", "U", "V", "W", "X", "Y"};
	...
	public MyCaptchaRender(String code)
	{
		this.myCode = code;
	}
	/**
