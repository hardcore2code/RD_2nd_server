...
public class QRcodeKit 
{
	...
	public static void main(String[] args) {
		...
		String contents = "你好,李四! welcome to zxing!"
				...
				+ "\nEmail[xxx@163.com]";
		// 普通二维码的生成与解析
		QRcodeKit.encodePR(contents, 300, 300, imgPath);
		System.out.println("生成二维码成功");
		System.out.println(QRcodeKit.decodePR(imgPath));

		// 带图片的二维的生成与解析
//		imgPath = "d:/pr2.png";
//		String srcPath = "d:/src.jpg";
//		QRcodeKit.encodePR(contents, 300, 300, srcPath,imgPath);
//		System.out.println("生成带图片的二维码成功");
//		System.out.println(QRcodeKit.decodePR(imgPath));

		// 条形码的生成与解析
//		imgPath = "d:/bar.png";
//		QRcodeKit.encodeBar("6923450657713", 105, 50, imgPath);
//		System.out.println("生成条形码成功");
//		System.out.println(QRcodeKit.decodeBar(imgPath));
	}
}
