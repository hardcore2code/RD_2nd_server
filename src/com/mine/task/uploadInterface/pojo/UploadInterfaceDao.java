package com.mine.task.uploadInterface.pojo;
...
public class UploadInterfaceDao extends BaseDao
{
	public List<Record> queryBillList()
	{
		Timestamp time = super.getSysdate();
		Date date = new Date();  
		date = time;
		String dateStr = DateKit.toStr(date);
		...
		sb.append("where status in ('03','04','10','11','12','13')   ");
		sb.append("and CONVERT(varchar(12),jsdate, 23 ) = '"+dateStr+"' ");
